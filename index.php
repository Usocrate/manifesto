...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo SKIN_URL ?>home.css" />
</head>
<body>
		...
		<section id="manifesto">
			...
			<div>
				...
				<div class="card-group">
					<div class="card">
						<div class="card-block">
							<h4 class="card-title">1- Porter toute l'attention aux usagers</h4>
							<div class="card-text">
								<ul>
									<li>Aller à la rencontre des usagers : pas de conception sans usagers</li>
									<li>Respecter les usagers</li>
									<li>Aimer le réel</li>
								</ul>
								<div>
									<p>Moi usocrate...</p>
									...
									<ul>
										...
										<li>Affirmer la dimension éthique du design</li>
									</ul>
									<p>Moi usocrate...</p>
									<ul>
